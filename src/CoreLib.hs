...
primitives = Map.fromList [
    ...
    , ("==", Builtin 2 compareEq (tParse "a0 -> a0 -> Bool"))
    , ("!=", Builtin 2 compareNeq (tParse "a1 -> a1 -> Bool"))
    , ("<", Builtin 2 compareLt (tParse "a2 -> a2 -> Bool"))
    , ("<=", Builtin 2 compareLte (tParse "a3 -> a3 -> Bool"))
    , (">", Builtin 2 compareGt (tParse "a4 -> a4 -> Bool"))
    , (">=", Builtin 2 compareGte (tParse "a5 -> a5 -> Bool"))
    , ("length", Builtin 1 listLength (tParse "[a6] -> Int"))
    , ("head", Builtin 1 listHead (tParse "[a7] -> a7"))
    , ("tail", Builtin 1 listTail (tParse "[a8] -> [a8]"))
    , ("cons", Builtin 2 listCons (tParse "a9 -> [a9] -> [a9]"))
    , ("isEmpty", Builtin 1 listIsEmpty (tParse "[a10] -> Bool"))
    , ("println", Builtin 1 (printStr True) (tParse "Str -> ()"))
    , ("print", Builtin 1 (printStr False) (tParse "Str -> ()"))
    , ("printVarLn", Builtin 1 (printVar True) (tParse "a11 -> ()"))
    , ("printVar", Builtin 1 (printVar False) (tParse "a12 -> ()"))
    , ("getLine", Builtin 0 (readFrom stdin) (tParse "Str"))
    , ("show", Builtin 1 showVar (tParse "a13 -> Str"))
